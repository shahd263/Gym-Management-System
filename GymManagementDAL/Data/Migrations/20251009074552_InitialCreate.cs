        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PlanValidDurationDaysCheck", "DurationDays between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("SessionValidCapacitycheck", "Capacity between 1 and 25");
                    table.CheckConstraint("SessionValidDateCheck", "StartDate < EndDate");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionBookings", x => new { x.MemberId, x.SessionId });
                    table.ForeignKey(
                        name: "FK_SessionBookings_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
